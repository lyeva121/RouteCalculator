...
with col_dev:
    st.markdown("<p style='text-align: right; font-style: italic; color: gray; margin-top: 25px;'>Разработчик Лёвочкин Виктор</p>", unsafe_allowed_html=True)
...
with col_cb:
    st.markdown("<br>", unsafe_allowed_html=True)  # Выравнивание чекбокса по высоте
